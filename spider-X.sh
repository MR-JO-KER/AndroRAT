#!/bin/bash
#my name is dark i from egypt I Hacker 
#https://t.me/name_dark
#https://github.com/MR-DARK54
trap 'printf "\n";stop;exit 1' 2
deps() {
...
figlet M R - D A R K 
printf "\n"
printf " \e[1;93m MR-DARK\e[0m \n"
printf " \033[1;35minstagram:name__dark | \033[1;34mhttps://t.me/name_dark \e[0m \n"
printf "\n"
